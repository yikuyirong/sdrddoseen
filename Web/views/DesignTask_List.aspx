<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignTask_List.aspx.cs"
    Inherits="Web.views.DesignTask_list" %>
                                ...
                                <tr>
                                    ...
                                    <td width="147">
                                        <input type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="项目名称/设总/主设" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center;cursor:pointer" onclick="scan('ProjectName,DesignManager,DesignMain',keywords.value)">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="ProjectList" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center">
                        <a onclick="parent.window.open('../views/DesignTask_Info.aspx?type=read&ClassName1=<%#Server.UrlEncode(Eval("ClassName1").ToString())%>&ProjectID=<%#Eval("ProjectID")%>')" target="_blank" style="text-decoration: underline;">任务明细</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
