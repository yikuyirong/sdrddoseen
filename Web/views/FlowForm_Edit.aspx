<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowForm_Edit.aspx.cs" Inherits="Web.views.FlowForm_Edit"
...
<head>
    ...
    <script>
		...
		'italic', 'underline', 'strikethrough', 'lineheight', 'removeformat', '|', 'image', 'table', 'hr', 'emoticons', '|', 'example1']
            });
        });
    </script>
    <style>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" align="center" style="line-height: 24px"
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="IF_Content" cols="100" rows="8" style="width: 700px; height: 400px;
