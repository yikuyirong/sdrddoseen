<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeekWork_List.aspx.cs"
    Inherits="Web.views.WeekWork_List" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20" limit="WeekWork_add">
                                        <img src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="60" limit="WeekWork_add">
                                        <span onclick="parent.window.open('../views/WeekWork_add.aspx')" style="cursor: pointer;">
                                            新增工作</span>
                                    </td>
            ...
            <asp:Repeater ID="Rep_List" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center">
                            <a limit="WeekWork_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'" style="text-decoration: underline;">
                                删除</a> <a limit="WeekWork_Edit" onclick="parent.window.open('../views/WeekWork_Edit.aspx?id=<%#Eval("ID") %>')" target="_blank"
                                    style="text-decoration: underline;">编辑</a> <a onclick="parent.window.open('../views/info_detail.aspx?ID=<%#Eval("ID") %>')" target="_blank"
