<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBuilderContractPay_List.aspx.cs"
    Inherits="Web.views.ProjectBuilderContractPay_list" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20" limit="ProjectBuilderContractPay_add">
                                        <img src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="84" limit="ProjectBuilderContractPay_add">
                                        <span onclick="parent.window.open('../views/ProjectBuilderContractPay_add.aspx')"
                                            style="cursor: pointer;">新增施工收费</span>
                                    </td>
                                    ...
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center" onclick="">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="Rep_List" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center">
                            <a limit="ProjectBuilderContractPay_List.del" href="#" onclick="location.href='?limit=del&id=<%#Eval("ID")%>'" style="text-decoration: underline;">
                                删除</a> <a limit="ProjectBuilderContractPay_Edit" onclick="parent.window.open('../views/ProjectBuilderContractPay_Edit.aspx?id=<%#Eval("ID")%>')"
                                    target="_blank" style="text-decoration: underline;">编辑</a> <a onclick="parent.window.open('../views/ProjectBuilderContractPay_Edit.aspx?type=read&id=<%#Eval("ID")%>')"
