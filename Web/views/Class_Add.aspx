<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Class_Add.aspx.cs" Inherits="Web.views.Class_Add" %>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td width="280">
                        <asp:DropDownList ID="ParentID" runat="server" size="10" class="select" check="必,空,0,20">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="280">
                        <asp:TextBox runat="server" ID="ClassName" TextMode="MultiLine" class="area" check="必,空,0,500"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td width="120" align="right">
