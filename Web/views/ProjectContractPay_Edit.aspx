<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectContractPay_Edit.aspx.cs"
    Inherits="Web.views.ProjectContractPay_Edit" %>
        ...
        <ContentTemplate>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="PCP_Num" Enabled="false" check="必,空,0,100">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly="readonly" type="text" id="PCP_MoneyTime" runat="server" check="必,空,0,100"
