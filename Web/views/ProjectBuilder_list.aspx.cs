...
namespace Web.views
{
    public partial class ProjectBuilder_list : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            ////绑定分页数据
            //ProjectList.DataSource = WebBLL.Tbl_ProjectManager.GetDataTableByPage(AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex, strWhere, "id desc");
