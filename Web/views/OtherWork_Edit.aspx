<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherWork_Edit.aspx.cs"
    Inherits="Web.views.OtherWork_Edit" ValidateRequest="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
			...
			<tr>
                ...
                <td class="tdbg"><asp:TextBox runat='server' ID='UserName' class='input' check='必,空,0,100' >doseen</asp:TextBox></td>
            </tr>
			<tr>
