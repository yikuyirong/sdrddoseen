...
namespace Web.views
{
    public partial class ProjectBuilderContractPay_list : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            //绑定分页数据
            Rep_List.DataSource = WebBLL.Tbl_ProjectContractPayManager.GetDataTableByPage(AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex, strWhere, "id desc");
            Rep_List.DataBind();
        }
