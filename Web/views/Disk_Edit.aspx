<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disk_Edit.aspx.cs"
    Inherits="Web.views.Disk_Edit" ValidateRequest="false" %>
...
<body>
    ...
    <br>
			...
			<tr>
                ...
                <td class="tdbg"><asp:FileUpload runat='server' ID='D_File' class='input' check='' /></td>
            </tr>
			<tr>
