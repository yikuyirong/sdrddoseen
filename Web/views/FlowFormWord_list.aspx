<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowFormWord_List.aspx.cs"
    Inherits="Web.views.FlowFormWord_list" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20">
                                        <img limit="FlowFormWord_add" src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="60">
                                        <span limit="FlowFormWord_add" onclick="parent.window.open('../views/FlowFormWord_add.aspx')" style="cursor: pointer;">
                                            新增短语</span>
                                    </td>
                                    ...
                                    <td width="147">
                                        <input runat="server" type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="短语" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center;cursor:pointer" onclick="scan('IFW_Name',keywords.value)">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="ProjectList" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center">
                            <a limit="FlowFormWord_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'"  style="text-decoration: underline;">删除</a> <a limit="FlowFormWord_Edit" onclick="parent.window.open('../views/FlowFormWord_Edit.aspx?id=<%#Eval("ID")%>')"
                                target="_blank" style="text-decoration: underline;">编辑</a> <a onclick="parent.window.open('../views/FlowFormWord_Edit.aspx?type=read&id=<%#Eval("ID") %>')"
