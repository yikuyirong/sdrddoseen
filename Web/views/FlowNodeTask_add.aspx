<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowNodeTask_Add.aspx.cs"
    Inherits="Web.views.FlowNodeTask_add" %>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td width="280">
                        <asp:DropDownList ID="FlowWorkID" runat="server" check="必,空,0,100" AutoPostBack="true" 
                            onselectedindexchanged="FlowWorkID_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:DropDownList ID="FlowNodeID" runat="server" check="必,空,0,100">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
