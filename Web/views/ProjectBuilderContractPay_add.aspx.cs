...
namespace Web.views
{
    public partial class ProjectBuilderContractPay_add : System.Web.UI.Page
    {
        ...
        {
            PCP_Num.Value = (WebBLL.Tbl_ProjectContractPayManager.GetDataTableByCount("PCP_Type='施工付款' and ProjectContractID=" + ContractID.SelectedValue) + 1).ToString();
        }
    }
}