...
namespace Web.views
{
    public partial class ProjectOuterDesignPay_add : System.Web.UI.Page
    {
        ...
        {
            PCP_Num.Value = (WebBLL.Tbl_ProjectContractPayManager.GetDataTableByCount("PCP_Type='设计外包付款' and ProjectContractID=" + ContractID.SelectedValue) + 1).ToString();
        }
    }
}