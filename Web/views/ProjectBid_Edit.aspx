<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBid_Edit.aspx.cs"
    Inherits="Web.views.ProjectBid_Edit" %>
        ...
        <ContentTemplate>
            ...
            <table border="0" cellspacing="0" cellpadding="5" width="400" align="center" style="line-height: 24px">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="PB_Name" runat="server" Enabled="false" CssClass="input" check="必,空,0,100"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList runat="server" ID="Status" RepeatDirection="Horizontal" check="选,空,0,40">
