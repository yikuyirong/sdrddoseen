<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowNode_Edit.aspx.cs" Inherits="Web.views.FlowNode_Edit" ValidateRequest="false" %>
        ...
        <ContentTemplate>
            <table border="0" cellspacing="0" cellpadding="5" width="820" align="center" style="line-height: 24px">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="FlowName" runat="server" Enabled="false" check="必,空,0,100" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" readonly="readonly" Enabled="false" id="NodeNo" class="input2" runat="server"
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="NodeUserLimit" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Text="允许跳回" Value="允许跳回"></asp:ListItem>
