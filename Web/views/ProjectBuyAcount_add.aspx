<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBuyAcount_Add.aspx.cs"
    Inherits="Web.views.ProjectBuyAcount_add" %>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                   <td align="right">
                    ...
                    <td>
                        <input runat="server" type="text" id="PO_Phone" check="必,空,0,100"  size="22"
                            class="input1" />
                    </td>
                </tr>
                <tr>
