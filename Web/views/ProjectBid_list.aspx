<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBid_List.aspx.cs"
    Inherits="Web.views.ProjectBid_list" %>
...
<body>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20" limit="ProjectBid_add">
                                        <img src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="60" limit="ProjectBid_add">
                                        <span onclick="parent.window.open('../views/ProjectBid_add.aspx')" style="cursor: pointer;">新增客户</span>
                                    </td>
                                    ...
                                    <td width="147">
                                        <input runat="server" type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="客户项目名称/客户状态" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center;cursor:pointer" onclick="scan('PB_Name,Status',keywords.value)">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="Rep_list" runat="server">
                ...
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center">
                            <a limit="ProjectBid_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'"  style="text-decoration: underline;">删除</a> <a limit="ProjectBid_Edit" onclick="parent.window.open('../views/ProjectBid_Edit.aspx?id=<%#Eval("ID")%>')"
                                target="_blank" style="text-decoration: underline;">编辑</a> <a onclick="parent.window.open('../views/ProjectBid_Edit.aspx?type=read&id=<%#Eval("ID")%>')"
    ...
    <webdiyer:AspNetPager ID="AspNetPager1" UrlPaging="true" EnableUrlRewriting="true"
        UrlRewritePattern="DoSeen_InfoList.html?classid=%classid%&page={0}" runat="server"
        ShowFirstLast="true" LayoutType="Div" PageIndexBoxClass="PageSelect" CurrentPageButtonClass="PageSel"
