...
namespace Web.views
{
    public partial class ProjectContractPay_Edit : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            this.PCP_MoneyTime.Value = contract.PCP_MoneyTime.ToString();
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            contract.PCP_Price = 0; // Convert.ToInt32(this.PCP_Price.Value);
            contract.PCP_MoneyTime =this.PCP_MoneyTime.Value;
