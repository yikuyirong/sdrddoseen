<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info_Add.aspx.cs" Inherits="Web.views.Info_add" ValidateRequest="false" %>
...
<body>
    ...
    <form id="form1" name="form1" runat="server" style="width: 820px;">
        <br />
        <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="False">
        </asp:ScriptManager>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
              <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="820" style="line-height: 24px">
                    <tr>
                    ...
                    <tr class="tdbg">
                        <td height="60" align="center" colspan="4">
                            <input id="sss" type="button" class="aler-btn" runat="server" value="确定提交" onclick="if(checkform(document.forms[0]))"
                                onserverclick="btnSave_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <input name="" type="button" class="aler-btn" onclick="window.external.close()" value="关闭窗口" />                        </td>
                    </tr>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
