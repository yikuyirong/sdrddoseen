<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Schedule_List.aspx.cs"
    Inherits="Web.views.Schedule_list" %>
                                ...
                                <tr>
                                    ...
                                    <td width="147">
                                        <input runat="server" type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="进度情况" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
    ...
    <div id="maindiv" onscroll="mymove()">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" style="background: #f0f0f0">
            ...
            <tr class="tr1">
                ...
                <td align="center">
                    <a limit="Schedule_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'"  style="text-decoration: underline;">删除</a> <a limit="oa_note_info" onclick="parent.window.open('../views/oa_note_info.asp')"
