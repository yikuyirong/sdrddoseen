<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBuilderLog_Edit.aspx.cs"
    Inherits="Web.views.ProjectBuilderLog_Edit" %>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="440" align="center">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ProjectTypes" runat="server" check="选,空,0,100" AutoPostBack="true"
                ...
                <tr>
                    ...
                    <td>
                        <input class="input" id="PBL_Wind" type="text" runat="server" check="必,空,0,100" size="22" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
