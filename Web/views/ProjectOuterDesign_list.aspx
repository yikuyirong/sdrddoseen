<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectOuterDesign_List.aspx.cs"
    Inherits="Web.views.ProjectOuterDesign_list" %>
...
<body>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20" limit="ProjectOuterDesign_add">
                                        <img src="../images/application_form_add.png" alt="新增外包" />
                                    </td>
                                    <td width="60" limit="ProjectOuterDesign_add">
                                        <span onclick="parent.window.open('../views/ProjectOuterDesign_add.aspx')" style="cursor: pointer;">
                                            新增外包</span>
                                    </td>
                                    ...
                                    <td width="147">
                                        <input runat="server" type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="外包内容" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center;cursor:pointer" onclick="scan('PO_Content',keywords.value)">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="ProjectList" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td>
                            <a limit="ProjectOuterDesign_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'" style="text-decoration: underline;">删除</a> <a limit="ProjectOuterDesign_Edit" onclick="parent.window.open('../views/ProjectOuterDesign_Edit.aspx?id=<%#Eval("ID")%>')"
                                target="_blank" style="text-decoration: underline;">编辑</a> <a onclick="parent.window.open('../views/ProjectOuterDesign_Edit.aspx?type=read&id=<%#Eval("ID")%>')"
    ...
    <div class="btmdo">
        <input runat="server" class="selectAll" name="checkbox" type="checkbox" onclick="if(this.checked){$('.sel').attr('checked','checked')}else{$('.sel').removeAttr('checked')}" />
        <span>全选</span>
