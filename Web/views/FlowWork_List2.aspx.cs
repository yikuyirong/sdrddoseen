...
namespace Web.views
{
    public partial class FlowWork_list2 : System.Web.UI.Page
    {
        ...
        public void Bind()
        {
            ...
            //绑定分页数据
            Rep_List.DataSource = WebBLL.Tbl_ProjectManager.GetDataTableByPage(AspNetPager1.PageSize, AspNetPager1.CurrentPageIndex, strWhere, "id desc");
            Rep_List.DataBind();
        }
