<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OtherWork_List.aspx.cs"
    Inherits="Web.views.OtherWork_List" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20" limit="OtherWork_add">
                                        <img src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="36" limit="OtherWork_add">
                                        <span onclick="parent.window.open('../views/OtherWork_add.aspx')" style="cursor: pointer;">
                                            新增</span>
                                    </td>
    ...
    <div id="maindiv" onscroll="mymove()">
        <table width="100%" border="0" cellpadding="0" cellspacing="1" style="background: #f0f0f0">
            ...
            <tr id="titlediv" class="td1" style="position: absolute">
                ...
                <td class="title_bg">项目</td>
                <td class="title_bg">姓名</td>
                <td class="title_bg">类型</td>
                <td class="title_bg">工日</td>
                <td class="title_bg">内容</td>
                <td class="title_bg">审核人</td>
            ...
            <asp:Repeater ID="Rep_list" runat="server">
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td align="center"><%#Eval("WorkDay") %></td>
                        <td align="center"><%#Eval("WorkInfo") %></td>
                        ...
                        <td align="center">
                            <a limit="OtherWork_List.del" href="#" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'" style="text-decoration: underline;">
                                删除</a> <a limit="OtherWork_Edit" onclick="parent.window.open('../views/OtherWork_Edit.aspx?id=<%#Eval("ID") %>')" target="_blank"
                                    style="text-decoration: underline;">编辑</a>
                             <a class="<%#Eval("Status").ToString()=="未审核"?"":"none"%> <%#Eval("NodeUser").ToString()==WebCommon.Public.GetUserName()?"":"none"%>" href="?id=<%#Eval("ID") %>&pass=1" style="text-decoration: underline;">通过</a>
                             <a class="<%#Eval("Status").ToString()=="未审核"?"":"none"%> <%#Eval("NodeUser").ToString()==WebCommon.Public.GetUserName()?"":"none"%>" href="?id=<%#Eval("ID") %>&pass=0" style="text-decoration: underline;">拒绝</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
