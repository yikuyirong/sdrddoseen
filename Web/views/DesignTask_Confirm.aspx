<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignTask_Confirm.aspx.cs"
    Inherits="Web.views.DesignTask_Confirm" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <br />
            <div id="div1" style="width:1175px;overflow-y:scroll;overflow-x: hidden; height: 400px; border: solid 1px gray;">
                ...
                <tr>
                    <td>
                        <input id="Button2" type="button" class="aler-btn" runat="server" value="同意任务" onserverclick="Button2_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="Button3" runat="server" type="button" class="aler-btn none" onserverclick="Button3_Click" value="不同意全部" />
                        <input id="Button4" runat="server" type="button" class="aler-btn" onserverclick="Button4_Click" value="不同意任务" />
                    </td>
                </tr>
            </table><br />
        </ContentTemplate>
