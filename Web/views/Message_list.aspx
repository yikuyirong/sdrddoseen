<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_List.aspx.cs" Inherits="Web.views.Message_list" %>
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20">
                                        <img limit="Message_add" src="../images/application_form_add.png" alt="新增" />
                                    </td>
                                    <td width="60">
                                        <span limit="Message_add" onclick="parent.window.open('../views/Message_add.aspx')" style="cursor: pointer;">
                                            发送消息</span>
                                    </td>
                                    ...
                                    <td width="147">
                                        <input runat="server" type="text" style="color:#ccc;height: 20px; width: 145px; border: 1px solid #8a8a8a;line-height: 20px;font-size:12px"
                                            id="keywords" value="来自谁/发往谁/消息内容" onfocus="this.value=''" name="keywords" />
                                    </td>
                                    <td width="48">
                                        <a style="display: block; width: 40px; padding: 2px 0; background: #93bc12; border: 1px solid #7b9e0d;
                                            color: #fff; text-align: center;cursor:pointer" onclick="scan('UserNameFrom,UserNameTo,MessageInfo',keywords.value)">
                                            搜索</a>
                                    </td>
                                </tr>
                            </table>
            ...
            <asp:Repeater ID="Rep_List" runat="server">
                <ItemTemplate>
                    <tr class="tr1" 
                        ...
                        <td align="center">
                            <a limit="Message_List.del" class="none underline" onclick="if(confirm('确定要删除吗？')) location.href='?limit=del&id=<%#Eval("ID")%>'">删除</a> <a onclick="parent.window.open('../views/Message_Detail.aspx?ID=<%#Eval("ID") %>')" target="_blank"
                                    style="text-decoration: underline;">查看</a> <a onclick="parent.window.open('../views/Message_Add.aspx?usernameto=<%#Server.UrlEncode(Eval("UserNameFrom").ToString()) %>')" target="_blank"
                                    style="text-decoration: underline;">回复</a>
                        </td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
