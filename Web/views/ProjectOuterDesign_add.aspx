<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectOuterDesign_Add.aspx.cs"
    Inherits="Web.views.ProjectOuterDesign_add" %>
        ...
        <ContentTemplate>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td>
                         <asp:DropDownList runat="server" ID="PO_CompanyType" check="必,空,0,100" AutoPostBack="true"
                            onselectedindexchanged="PO_CompanyType_SelectedIndexChanged">
                        </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <input id="PO_StartTime" type="text"  readonly="readonly"  runat="server" check="必,空,0,100" size="22" class="input1"
                ...
                <tr>
                    ...
                    <td>
                        <textarea cols="35" rows="5" id="PO_Content" runat="server" check="必,空,0,200" class="area"></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <input runat="server" type="text" id="PO_Price" check="必,数,0,100" value="0" size="22"
                            class="input1" />
                    </td>
                </tr>
                <tr>
