<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectOuterPay_Add.aspx.cs"
    Inherits="Web.views.ProjectOuterPay_add" %>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="800" align="center"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList CssClass="pro_name" runat="server" ID="ProjectID" check="必,空,0,100" AutoPostBack="true"
                            OnSelectedIndexChanged="ProjectID_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:HiddenField ID="POP_Type" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="POP_Num" check="必,空,0,100" AutoPostBack="true" 
                            onselectedindexchanged="POP_Num_SelectedIndexChanged">
                ...
                <tr>
                    ...
                    <td runat="server" id="jiedian">
                        <input type="text" name="POP_MoneyTime" check="必,空,0,100" class="input1" style="width:45px" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td runat="server" id="kuanxiang">
                        <input type="text" name="POP_Money" value="0" check="必,数,0,100" class="input1" style="width:45px" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:RadioButtonList runat="server" ID="PC_FeeType" RepeatDirection="Horizontal"
                            check="必,空,0,100">
                            <asp:ListItem Value="现金" Text="现金" Selected="True"></asp:ListItem>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="Status" runat="server" RepeatDirection="Horizontal" check="必,空,0,100">
                            ...
                            <asp:ListItem Text="已付" Value="已付"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
