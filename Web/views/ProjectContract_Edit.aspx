<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectContract_Edit.aspx.cs"
    Inherits="Web.views.ProjectContract_Edit" %>
...
<body>
    ...
    <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
        ...
        <tr>
            ...
            <td>
                <input id="PC_Name" class="input1" type="text" runat="server" check="必,空,0,100" />
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td>
                <input id="PC_Price" class="input1" type="text" runat="server" check="必,数,0,100" />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <input id="PC_MoneyReceive" class="input1" type="text" runat="server" check="必,数,0,100" />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <input id="PC_MoneyBill" class="input1" type="text" runat="server" check="必,数,0,100" />
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:RadioButtonList runat="server" ID="PC_FeeType" RepeatDirection="Horizontal"
                    ...
                    <asp:ListItem Value="混用" Text="混用 "></asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RadioButtonList runat="server" ID="Status" RepeatDirection="Horizontal">
                    <asp:ListItem Value="评审通过" Text="评审通过"></asp:ListItem>
                    <asp:ListItem Value="评审未过" Text="评审未过"></asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
