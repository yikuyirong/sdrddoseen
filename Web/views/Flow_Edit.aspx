<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Flow_Edit.aspx.cs" Inherits="Web.views.Flow_Edit" %>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="FlowType" Enabled="false" runat="server" RepeatDirection="Horizontal">
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="FormID" runat="server" Enabled="false"  style="width:130px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
