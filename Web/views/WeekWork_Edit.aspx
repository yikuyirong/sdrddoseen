<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeekWork_Edit.aspx.cs"
    Inherits="Web.views.WeekWork_Edit" ValidateRequest="false" %>
        ...
        <ContentTemplate>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="800" align="center"
                ...
                <tr>
                    ...
                    <td class="tdbg">
                        <asp:DropDownList ID="ClassID" runat="server" class="select1" check="必,空,0,20">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr class="tdbg">
                ...
                <tr class="tdbg" style="display: none">
                    ...
                    <td>
                        <asp:FileUpload ID="I_Pic" runat="server" class="input2" check="选,空,0,50" />
                    </td>
                </tr>
                <tr class="tdbg" style="display: none">
                    <td align="right">
                ...
                <tr class="tdbg" style="display: none">
                    ...
                    <td>
                        <asp:FileUpload ID="I_File" runat="server" class="input2" check="选,空,0,50" />
                    </td>
                </tr>
                <tr class="tdbg" style="display: none">
                    <td align="right">
