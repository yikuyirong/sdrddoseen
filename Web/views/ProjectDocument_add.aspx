<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectDocument_Add.aspx.cs"
    Inherits="Web.views.ProjectDocument_add" %>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="450" align="center"
                ...
                <tr>
                    ...
                    <td width="350">
                        ...
                        <asp:DropDownList CssClass="pro_name" ID="ProjectID" runat="server" check="必,空,0,100">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="ClassNameFrom" RepeatDirection="Horizontal" runat="server"></asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="PD_Type" runat="server" check="必,空,0,100" 
                            ...
                            <asp:ListItem Selected="True" Text="新增提资" Value="新增提资"></asp:ListItem>
                            <%--<asp:ListItem Text="问题修改" Value="问题修改"></asp:ListItem>--%>
