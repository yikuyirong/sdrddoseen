<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Limit_Add.aspx.cs" Inherits="Web.views.Limit_Add" %>
                ...
                <tr class="tdbg">
                    ...
                    <td>
                        <div id="div1" style="width: auto; overflow: hidden; height: 200px; border: solid 1px gray;">
                            ...
                            <input name="LimitInfo" type="checkbox" title="权限：系统设置->系统参数" value="Config" />系统参数
                        </div>
                        *鼠标移到选择框上可以显示选项的权限内容
                    </td>
                </tr>
