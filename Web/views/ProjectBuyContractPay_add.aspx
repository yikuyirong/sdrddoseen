<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectBuyContractPay_Add.aspx.cs"
    Inherits="Web.views.ProjectBuyContractPay_add" %>
        ...
        <ContentTemplate>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td>
                        <input readonly="readonly" type="text" value="1" id="PCP_Num" runat="server" check="必,空,0,100" size="22" class="input1" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <input type="text" id="PCP_Money" value="0" runat="server" check="必,空,0,100" size="22" class="input1" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <input type="text" runat="server" value="0" id="PCP_Price" check="必,空,0,100" size="22" class="input1" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
