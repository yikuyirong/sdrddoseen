<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Add.aspx.cs" Inherits="Web.views.User_add" %>
        ...
        <ContentTemplate>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="600" align="center"
                ...
                <tr>
                    ...
                    <td>
                        <input class="input1" runat="server" id="U_GraduateTime" type="text"
                            check="必,日,0,40" size="22" value="1900-01-01" /><img src="../images/date.jpg"  onclick="calendar.setHook(U_GraduateTime)" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:DropDownList ID="U_JobID" runat="server" check="必,空,0,100" OnSelectedIndexChanged="U_JobID_SelectedIndexChanged"
                            AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td align="right">
                    ...
                    <td>
                        <input class="input1" runat="server" id="U_EntryTime" type="text"
                            check="必,日,8,40" size="22" value="1900-01-01" /><img src="../images/date.jpg"  onclick="calendar.setHook(U_EntryTime)" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:DropDownList ID="U_JobRank" runat="server" check="必,空,0,100" OnSelectedIndexChanged="U_JobID_SelectedIndexChanged"
                            AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td align="right">
                    ...
                    <td>
                        <input class="input1" runat="server" id="U_ContractStartTime" type="text" check="选,日,8,40"
                            size="22" value="1900-01-01" /><img src="../images/date.jpg"  onclick="calendar.setHook(U_ContractStartTime)" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:DropDownList ID="U_JobTitle" runat="server" check="必,空,0,100" OnSelectedIndexChanged="U_JobID_SelectedIndexChanged"
                            AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td align="right">
                    ...
                    <td>
                        <input class="input1" runat="server" id="U_ContractEndTime" type="text"
                            check="必,日,8,40" size="22" value="1900-01-01" /><img src="../images/date.jpg"  onclick="calendar.setHook(U_ContractEndTime)" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <asp:DropDownList ID="U_Specialty" runat="server">
                        </asp:DropDownList>
                    </td>
                    <td align="right">
                        入档时间：
                    ...
                    <td>
                        <input class="input1" runat="server" id="U_DocumentTime" type="text"
                            check="必,日,8,40" size="22" value="1900-01-01" /><img src="../images/date.jpg"  onclick="calendar.setHook(U_DocumentTime)" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td>
                        <input  class="input1" runat="server" id="U_Name" type="text" check="必,空,0,100" size="22" />
                    </td>
                    <td align="right">
                        手机：
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input  class="input1"  runat="server" id="U_Email" type="text" check="选,空,0,40" size="22" />
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox class="input1" ID="UserPwd" runat="server" TextMode="Password" check="必,空,0,100"
                            size="22"></asp:TextBox>
                    </td>
                </tr>
                <tr>
