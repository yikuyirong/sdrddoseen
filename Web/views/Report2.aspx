<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report2.aspx.cs" Inherits="Web.views.Report2" %>
                ...
                <ItemTemplate>
                    <tr class="tr1">
                        ...
                        <td style="vertical-align:top">                           
                                    <b><%#Eval("ProjectName")%><%#Eval("ProjectNo") %></b><br>
                                    项目状态：<%#Eval("Status")%><br>
                                    节点编号：<%#Eval("NodeNo")%><br>
                                    节点用户：<%#WebCommon.Public.CutStr(Eval("NodeUser").ToString(),7)%><br>
                                    预估工作量：<%#Eval("GuGongNum1")%><br>
                                    实际工作量：<%#Eval("GuGongNum2")%><br>
                        </td>
                        <td style="text-align:left">
                            <asp:Repeater ID="DesginTask" runat="server">
                                <ItemTemplate>
                                    <%#Eval("ClassName1")%>[<%#Eval("dt_tuhao")%>] - <%#Eval("DesignManager")%> - <%#Eval("DesignMain")%> - <%#Eval("DT_SheJiRen")%>（<%#Eval("DT_GuGong")%>工日） - <%#Convert.ToDateTime(Eval("DT_SheJiTime")).ToString("yyyy-MM-dd")%> <br>
                                </ItemTemplate>
                            </asp:Repeater>
                        </td>
                    </tr>
