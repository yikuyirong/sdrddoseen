<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectOuter_Add.aspx.cs"
    Inherits="Web.views.ProjectOuter_add" %>
...
<head>
    ...
    <title>添加<%=Server.UrlDecode(Title)%></title>
            ...
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="400" align="center"
                ...
                <tr>
                    ...
                    <td width="290">
                        ...
                        <asp:DropDownList CssClass="pro_name" runat="server" ID="ProjectName" check="必,空,0,100">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                        <%=Server.UrlDecode(Title)%>单位：
                    </td>
                    <td>
                        <asp:DropDownList runat="server" ID="POC_Type1" check="必,空,0,100" AutoPostBack="true"
                            OnSelectedIndexChanged="POC_Type1_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:DropDownList runat="server" ID="POC_Type2" check="必,空,0,100" AutoPostBack="true"
                            OnSelectedIndexChanged="POC_Type2_SelectedIndexChanged">
                        </asp:DropDownList>
                        <asp:DropDownList runat="server" ID="PO_CompanyID" check="必,空,0,100"  
                            AutoPostBack="true" onselectedindexchanged="PO_CompanyID_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input runat="server" type="text" id="PO_PricePay" check="必,空,0,100" value="0" size="22"
                            class="input1" />
                     </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input runat="server" type="text" id="PO_PriceBill" check="必,空,0,100" value="0" size="22"
                            class="input1" />
                     </td>
                </tr>
                <tr>
