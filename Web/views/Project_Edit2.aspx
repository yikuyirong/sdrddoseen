<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Project_Edit22.aspx.cs" Inherits="Web.views.Project_Edit2" %>
        ...
        <ContentTemplate>
            <table id="tbl_add" border="0" cellspacing="0" cellpadding="5" width="440" align="center">
                ...
                <tr>
                    ...
                    <td width="280">
                        <asp:ListBox ID="ProjectMainDesigner" runat="server" check="必,空,0,1000" Width="200" Rows="10">
                        </asp:ListBox>
                    </td>
                </tr>
                <tr>
