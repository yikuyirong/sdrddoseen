 /*
      <input id="time1" name="time1" readonly="readonly" style="width:80" title="点击打开日期控件" onclick="javascript:calendar.setHook(this)" runat="server" />
    
       <input id="Text1" name="time1" readonly="readonly" style="width:80" title="点击打开日期控件" onclick="javascript:calendar.setHook(this)" runat="server" />
...
function cnVeryCalendar()
{
 ...
 this.generateCalendarTable = function()
 {
  ...
  body += " <a href='#' onclick=\"calendar.setValue('')\" style='color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[擦除]</a> ";
  body += " <a href='#' onclick='calendar.fadeOut()' style='color:" + fore_frameCaption + "; text-decoration:none;" + font_cnChar + "'>[关闭]</a>";
  body += " </div>";
  body += " </td>";
  body += " </tr>";
  body += " <tr>";
  ...
  body += " <tr>";
  body += " <td style='" + font_cnChar + "'><a href='#' onclick='calendar.loadPreviousYear()' style='text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>3</font></a>年<a href='#' onclick='calendar.loadNextYear()' style='text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>4</font></a></td>";
  body += " <td align='center' nowrap='nowrap' style='color:" + fore_currentMonth + ";" + font_cnChar + "'><b>"+ y + "年" + m + "月</b></td>";
  body += " <td align='right' style='" + font_cnChar + "'><a href='#' onclick='calendar.loadPreviousMonth()' style='text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>3</font></a>月<a href='#' onclick='calendar.loadNextMonth()' style='text-decoration:none; color:" + fore_dayMouseOver + "'><font face='webdings'>4</font></a></td>";
  body += " </tr>";
  body += " </table>";
  body += " </td>";
  body += " </tr>";
